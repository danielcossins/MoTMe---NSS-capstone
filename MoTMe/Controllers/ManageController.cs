...
////////Added methods
        ...
        {
            repo.AddContact(userId, contactId);
        }

        public string GetContactsByUserId(int uid)
        {
            string jsonString = javaScriptSerializer.Serialize(repo.GetContactsByUserId(uid));
            return jsonString;
        }

        public string GetContactUsersByUserId(int uid)
        {
